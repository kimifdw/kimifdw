...
- [swr1bm86/cluster-launcher](https://github.com/swr1bm86/cluster-launcher) - Painless mocking cluster (etcd, nacos, apollo, etc.) for testing
...
- [wx-chevalier/Startup-Notes](https://github.com/wx-chevalier/Startup-Notes) - 熊说财经与科技 ~ 某熊的创业之路
...
- [spring-projects-experimental/spring-grpc](https://github.com/spring-projects-experimental/spring-grpc) - 
...
- [making/oauth2-sso-demo](https://github.com/making/oauth2-sso-demo) - OIDC SSO Demo with Spring Boot + Spring Security
...
- [huixisheng/FE-Weekly](https://github.com/huixisheng/FE-Weekly) - 前端值得关注的周刊整理
...
- [alibaba/ChatLearn](https://github.com/alibaba/ChatLearn) - A flexible and efficient training framework for large-scale alignment tasks
...
- [apache/dubbo-python](https://github.com/apache/dubbo-python) - The python Implementation For Apache Dubbo.
...
- [eggjs/router](https://github.com/eggjs/router) - router for eggjs, fork from koa-router with some additional features
