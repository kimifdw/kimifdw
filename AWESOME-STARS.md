...
- [skipset](https://github.com/zhangyunhao116/skipset) - skipset is a high-performance concurrent sorted set based on skip list. Up to 3x ~ 15x faster than sync.Map in the typical pattern.
